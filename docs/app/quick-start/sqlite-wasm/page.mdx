...
an [Effect](https://effect.website/) from `effect` since this library uses it internally.
However, it can be executed independently of effect simply by awaiting it:
