...
Here's are the relevant code snippets divided up by the code the database thread will run 
...
so what you should really take away from this is that Medfetch.js yields resource "rows"
