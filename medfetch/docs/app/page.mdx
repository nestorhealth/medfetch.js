...
The section on [architecture]() goes further in depth into how (and how not) Medfetch.js follows the specs.
...
<Callout type="info"> 
<sup>1</sup> 
WebAssembly databases may be the exception to this rule, since the sql-on-fhir runner that Medfetch.js will use for this 
