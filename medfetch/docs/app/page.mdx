...
for either the [in-memory]() or your specific [in-memory](/sql) view runner. 
You don't need to read it all to start your FHIR to SQL pipeline, but if you're curious 
