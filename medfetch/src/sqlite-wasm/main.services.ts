...
export class Counter {
    ...
    constructor() {
        ...
        this.#counts = Object.fromEntries(MESSAGE_TYPES.map((type) => [type, 0] as const)) as MessageTypeObjMap<number>;
    }
    ...
    increment(msgType: BetterWorker1MessageType) {
        const count = this.#counts[msgType] = (this.#counts[msgType] || 0) + 1;
