...
interface NullableColumnPath
    extends Schema.Schema.Encoded<typeof _ColumnPath> {}
 ...
 * ```
 */
export const ColumnPath: Schema.Schema<ColumnPath, NullableColumnPath> =
    _ColumnPath;
...
const _Select = Schema.Struct({
    ...
    select: ow(
        Schema.Array(
            Schema.suspend(
                (): Schema.Schema<DefaultedSelect, BaseSelect> => _Select,
            ),
        ),
        { exact: true },
    ),
...
interface FHIRViewDefinition
    extends Schema.Schema.Encoded<typeof _ViewDefinition> {}

export const ViewDefinition: Schema.Schema<ViewDefinition, FHIRViewDefinition> =
    _ViewDefinition;
