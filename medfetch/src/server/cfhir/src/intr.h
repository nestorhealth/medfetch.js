...
/**
 * Executes the given interaction. If successful,
 * then intr->next is freed until `fhir_intr_json()`
 * is called onto it and maybe loads another link (if such a next link exists)
 * 
