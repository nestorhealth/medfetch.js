...
** SQLITE_SOURCE_ID "2025-03-12 15:17:13 6ec0c03b954cf705da076d035a1cc2e784233ae28857385379e44a59af6c5ec4"
**
** Using the Emscripten SDK version 4.0.5.
*/
...
globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3){
  sqlite3.version = {"libVersion": "3.50.0", "libVersionNumber": 3050000, "sourceId": "2025-03-12 15:17:13 6ec0c03b954cf705da076d035a1cc2e784233ae28857385379e44a59af6c5ec4","downloadVersion": 3500000};
});
...
(() => {
  // Create a small, never-async wrapper around sqlite3InitModule which
  // checks for callers incorrectly using it with `new`.
  var real_sqlite3InitModule = sqlite3InitModule;
  sqlite3InitModule = function(arg) {
    if (new.target) throw new Error("sqlite3InitModule() should not be called with `new sqlite3InitModule()`");
    return real_sqlite3InitModule(arg);
  }
})();
