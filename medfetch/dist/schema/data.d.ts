...
declare const _Constant: Schema.Struct<{
    ...
    valuePositiveInt: Schema.optionalWith<Schema.filter<typeof Schema.Positive>, {
        exact: true;
    }>;
    ...
    valueUnsignedInt: Schema.optionalWith<Schema.refine<number, typeof Schema.NonNegative>, {
        exact: true;
    }>;
