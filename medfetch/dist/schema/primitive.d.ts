...
export declare const positiveInt: Schema.filter<Schema.Schema<number, number, never>>;
export declare const time: typeof Schema.String;
export declare const unsignedInt: Schema.refine<number, Schema.Schema<number, number, never>>;
...
export declare const get: <TKey extends Key>(key: TKey) => {
    ...
    schema: {
        ...
        positiveInt: Schema.filter<Schema.Schema<number, number, never>>;
        time: typeof Schema.String;
        unsignedInt: Schema.refine<number, Schema.Schema<number, number, never>>;
