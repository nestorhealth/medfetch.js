 ...
 */
export declare function project(nd: View.Node, data: any | any[], evaluate: (data: any[], expr: string) => any[]): any[];
/**
 ...
 */
export declare function sof(viewDefinition: View.ViewDefinition, data: any[]): any[];
