...
export default function Showcase() {
  const showcaseItems = [
    {
      ...
      description: "Interactive spreadsheet interface for medical researchers to query patient data, analyze treatment outcomes, and generate reports.",
      features: ["Natural language queries", "Real-time data filtering", "Export capabilities", "Statistical analysis"],
      icon: Database,
      status: "Live Demo",
      complexity: "Advanced",
    ...
    },
    {
      ...
      description: "Comprehensive analytics dashboard for hospital administrators to track metrics, outcomes, and operational efficiency.",
      features: ["Performance metrics", "Trend analysis", "Custom reports", "KPI tracking"],
      icon: TrendingUp,
      status: "Coming Soon", 
      complexity: "Expert",
      href: "#"
  ...
  const getComplexityColor = (complexity: string) => {
    switch (complexity) {
      ...
      case "Advanced": return "bg-orange-900/30 text-orange-300 border-orange-700/30";
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case "Live Demo": return "bg-green-900/30 text-green-300 border-green-700/30";
      case "Beta": return "bg-blue-900/30 text-blue-300 border-blue-700/30";
      case "Coming Soon": return "bg-gray-900/30 text-gray-300 border-gray-700/30";
      default: return "bg-gray-900/30 text-gray-300 border-gray-700/30";
    }
  };
          ...
          <div className="text-center mb-12">
            <div className="inline-block mb-6">
              <div className="bg-gradient-to-r from-white/10 to-gray-300/10 backdrop-blur-sm border border-white/20 rounded-full px-6 py-2">
                <span className="text-white/90 text-sm font-medium">🎯 Live Demonstrations</span>
              </div>
            </div>
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
              Medfetch in 
              <span className="bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent"> Action</span>
            </h1>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Explore real-world applications of Medfetch across different healthcare scenarios. 
              From clinical research to administrative analytics, see how natural language transforms data interaction.
            </p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
            {stats.map((stat, index) => (
              <div key={index} className="bg-gray-900/40 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6 text-center hover:bg-gray-800/40 transition-all duration-300">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8">
            {showcaseItems.map((item, index) => {
              ...
              const isAvailable = item.status === "Live Demo" || item.status === "Beta";
              
              return (
                <div key={item.id} className="group relative">
                  <div className={`bg-gray-900/40 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-8 transition-all duration-300 h-full ${
                    isAvailable 
                    ...
                    <div className="flex items-start justify-between mb-6">
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        <span className={`px-3 py-1 rounded-full text-xs font-medium border ${getComplexityColor(item.complexity)}`}>
                          {item.complexity}
                        </span>
                      </div>
                    </div>
          ...
          <div className="bg-gray-900/30 backdrop-blur-lg border border-gray-600/50 rounded-3xl p-8 md:p-12">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-300 text-lg max-w-2xl mx-auto">
                Each showcase demonstrates real-world healthcare scenarios with production-ready features
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-white mb-3">Real Data Queries</h3>
                <p className="text-gray-300 text-sm leading-relaxed">
                  Work with realistic medical datasets and see how natural language translates to complex SQL queries in real-time.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-300 text-sm leading-relaxed">
                  Fully functional interfaces that respond to your inputs, demonstrating the full power of conversational data access.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-300 text-sm leading-relaxed">
                  See your data come alive with charts, graphs, and visualizations that update instantly based on your queries.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-r from-gray-800/40 to-gray-900/40 backdrop-blur-lg border border-gray-600/50 rounded-3xl p-12">
            ...
            <p className="text-gray-300 text-lg mb-8 max-w-2xl mx-auto">
              These demos show just a fraction of what's possible with Medfetch. Start building your custom healthcare data solution today.
            </p>
